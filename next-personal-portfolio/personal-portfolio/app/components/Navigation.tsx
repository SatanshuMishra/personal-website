							...
							<>
								...
								{options.map((option, key) => {
									return (
										<li
											key={key}
											className={`px-4 py-2 font-semibold border-b-2 border-b-transparent ${darkMode
								...
								{scroll && (
									...
									>
										{/* <SlideInLeft> */}
										<button
											className={`px-4 py-0.5 border-2 font-bold rounded-lg cursor-pointer duration-300 hover:duration-300 ${darkmode
