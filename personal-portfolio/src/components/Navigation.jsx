...
const Navigation = (props) => {
  ...
  const [width, setWidth] = useState(window.scrollY > 500);
  ...
  return (
    <div>
      <div
        className={`${darkmode && "dark"} w-screen bg-white fixed top-0 z-40`}
      >
          ...
          <ul className="flex flex-row justify-end items-center">
            {width ? (
              <>
                ...
                {options.map((option) => {
                  return (
                    <li className="px-4 py-2 font-semibold border-b-2 border-b-transparent hover:border-b-black cursor-pointer no-underline">
